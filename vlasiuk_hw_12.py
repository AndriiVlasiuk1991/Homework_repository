...
if __name__ == "__main__":
    ...
    print("Адресна книга збережена на диск.")

    # Читання адресної книги з файлу
    read_address_book = AddressBook()
    read_address_book.read_from_file("address_book.txt")
    print("Адресна книга відновлена з файлу:")
    for record in read_address_book.data.values():
        print(record)

    # Пошук
    search_query_1 = "Bill"  # Введіть пошуковий запит
    search_results = read_address_book.search(search_query_1)
    print(f"\nРезультати пошуку за запитом '{search_query_1}':")
    if search_results:
    ...
    search_query_2 = "0671515478"  # Введіть пошуковий запит
    search_results = read_address_book.search(search_query_2)
    print(f"\nРезультати пошуку за запитом '{search_query_2}':")
    if search_results:
        for result in search_results:
            print(result)
    else:
